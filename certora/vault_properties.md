...
| 13 | `(deposits[id].amount == 0 && deposits[id].owner == 0 && deposits[id].claimerId == 0 && deposits[id].lockUntil == 0) or (deposits[id].amount != 0 && deposits[id].claimerId != 0 && deposits[id].lockUntil != 0)` | high-level | low | Y | N |
