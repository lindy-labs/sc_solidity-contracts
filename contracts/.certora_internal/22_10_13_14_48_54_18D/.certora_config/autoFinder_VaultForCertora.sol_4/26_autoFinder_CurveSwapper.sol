...
abstract contract CurveSwapper {
    ...
    function _swapIntoUnderlying(
        ...
        uint256 _amount,
        uint256 _slippage
    ) internal returns (uint256 amount) {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00f60000, 1037618708726) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00f60001, 3) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00f61000, _token) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00f61001, _amount) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00f61002, _slippage) }
    ...
    function _swapFromUnderlying(
        ...
        uint256 _amount,
        uint256 _slippage
    ) internal returns (uint256 amount) {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00f50000, 1037618708725) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00f50001, 3) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00f51000, _token) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00f51001, _amount) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00f51002, _slippage) }
    ...
    function _calcMinDy(
        ...
        uint8 _toDecimals,
        uint256 _slippage
    ) internal pure returns (uint256) {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00f40000, 1037618708724) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00f40001, 4) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00f41000, _amount) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00f41001, _fromDecimals) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00f41002, _toDecimals) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00f41003, _slippage) }
        return
    ...
    function _approveIfNecessary(address _token, address _pool) internal {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00f70000, 1037618708727) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00f70001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00f71000, _token) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00f71001, _pool) }
    ...
    function _addPool(SwapPoolParam memory _param) internal {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00f90000, 1037618708729) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00f90001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00f91000, _param) }
        require(
    ...
    function _removePool(address _inputToken) internal {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00fa0000, 1037618708730) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00fa0001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00fa1000, _inputToken) }
        require(
