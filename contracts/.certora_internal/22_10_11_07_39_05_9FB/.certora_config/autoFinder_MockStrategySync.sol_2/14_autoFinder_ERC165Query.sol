...
library ERC165Query {
    ...
    function doesContractImplementInterface(
        address _contract,
        bytes4 _interfaceId
    ) internal view returns (bool) {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00850000, 1037618708613) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00850001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00851000, _contract) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00851001, _interfaceId) }
        uint256 success;
        uint256 result;
