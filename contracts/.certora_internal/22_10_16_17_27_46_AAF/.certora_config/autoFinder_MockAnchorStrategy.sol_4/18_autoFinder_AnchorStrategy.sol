...
contract AnchorStrategy is IAnchorStrategy, BaseStrategy {
     ...
     */
    function initRedeemStable(uint256 amount) public logInternal216(amount)onlyManager {
        if (amount == 0) revert StrategyAmountZero();
    ...
    }modifier logInternal216(uint256 amount) { assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00d80000, 1037618708696) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00d80001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00d80003, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00d86000, amount) } _; }
