...
contract AnchorStrategy is IAnchorStrategy, BaseStrategy {
     ...
     */
    function initRedeemStable(uint256 amount) public logInternal213(amount)onlyManager {
        if (amount == 0) revert StrategyAmountZero();
    ...
    }modifier logInternal213(uint256 amount) { assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00d50000, 1037618708693) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00d50001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00d50003, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00d56000, amount) } _; }
     ...
     */
    function _getUnderlyingBalance() internal view returns (uint256) {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00ce0000, 1037618708686) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00ce0001, 0) }
     ...
     */
    function _getUstBalance() internal view returns (uint256) {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00cf0000, 1037618708687) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00cf0001, 0) }
        return underlying.balanceOf(address(this));
    }
     ...
     */
    function _getAUstBalance() internal view returns (uint256) {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00d10000, 1037618708689) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00d10001, 0) }
    ...
    function _estimateUstAmountInAUst(uint256 ustAmount)
        ...
        view
        returns (uint256)
    {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00d20000, 1037618708690) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00d20001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00d21000, ustAmount) }
        if (ustAmount == 0) {
            return 0;
        }
     ...
     */
    function _estimateAUstBalanceInUst() internal view returns (uint256) {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00d00000, 1037618708688) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00d00001, 0) }
     ...
     */
    function _aUstToUstExchangeRate() internal view virtual returns (uint256) {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00d30000, 1037618708691) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00d30001, 0) }
        (
            uint80 roundID,
            int256 price,
            ,
