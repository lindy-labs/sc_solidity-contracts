    ...
    CustomErrors
{
    ...
    function getParams(uint64 lockDuration, uint64 amount, string memory name, uint256 slippage) external returns (DepositParams memory _params) {
    ...
    {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00500000, 1037618708560) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00500001, 0) }
        if (address(strategy) == address(0)) {
            return (0, 0);
        }
    ...
    function getUnderlying()
        ...
        returns (address)
    {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00530000, 1037618708563) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00530001, 0) }
