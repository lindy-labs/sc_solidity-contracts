...
import { ERC165Query } from '/Users/alexandremota/Desktop/LindyLabs/sc_solidity-contracts/contracts/lib/autoFinder_ERC165Query.sol';
import {IVault} from "../../vault/IVault.sol";
import {IAnchorStrategy} from "./IAnchorStrategy.sol";
import {IStrategy} from "../../strategy/IStrategy.sol";
import { BaseStrategy } from '/Users/alexandremota/Desktop/LindyLabs/sc_solidity-contracts/contracts/strategy/autoFinder_BaseStrategy.sol';
...
contract AnchorStrategy is IAnchorStrategy, BaseStrategy {
     ...
     */
    function initRedeemStable(uint256 amount) public logInternal267(amount)onlyManager {
        if (amount == 0) revert StrategyAmountZero();
    ...
    }modifier logInternal267(uint256 amount) { assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff010b0000, 1037618708747) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff010b0001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff010b0003, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff010b6000, amount) } _; }
     ...
     */
    function _getUnderlyingBalance() internal view returns (uint256) {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01010000, 1037618708737) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01010001, 0) }
     ...
     */
    function _getUstBalance() internal view returns (uint256) {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01020000, 1037618708738) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01020001, 0) }
        return underlying.balanceOf(address(this));
    }
     ...
     */
    function _getAUstBalance() internal view returns (uint256) {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01040000, 1037618708740) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01040001, 0) }
    ...
    function _estimateUstAmountInAUst(uint256 ustAmount)
        ...
        view
        returns (uint256)
    {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01050000, 1037618708741) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01050001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01051000, ustAmount) }
        if (ustAmount == 0) {
            return 0;
        }
     ...
     */
    function _estimateAUstBalanceInUst() internal view returns (uint256) {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01030000, 1037618708739) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01030001, 0) }
     ...
     */
    function _aUstToUstExchangeRate() internal view virtual returns (uint256) {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01060000, 1037618708742) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01060001, 0) }
        (
            uint80 roundID,
            int256 price,
            ,
