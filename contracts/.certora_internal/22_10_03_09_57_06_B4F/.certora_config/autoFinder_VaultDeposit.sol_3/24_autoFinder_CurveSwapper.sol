...
abstract contract CurveSwapper {
    ...
    function _swapIntoUnderlying(
        ...
        uint256 _amount,
        uint256 _slippage
    ) internal returns (uint256 amount) {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00d00000, 1037618708688) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00d00001, 3) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00d01000, _token) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00d01001, _amount) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00d01002, _slippage) }
    ...
    function _swapFromUnderlying(
        ...
        uint256 _amount,
        uint256 _slippage
    ) internal returns (uint256 amount) {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00cf0000, 1037618708687) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00cf0001, 3) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00cf1000, _token) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00cf1001, _amount) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00cf1002, _slippage) }
    ...
    function _calcMinDy(
        ...
        uint8 _toDecimals,
        uint256 _slippage
    ) internal pure returns (uint256) {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00ce0000, 1037618708686) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00ce0001, 4) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00ce1000, _amount) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00ce1001, _fromDecimals) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00ce1002, _toDecimals) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00ce1003, _slippage) }
        return
    ...
    function _approveIfNecessary(address _token, address _pool) internal {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00d10000, 1037618708689) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00d10001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00d11000, _token) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00d11001, _pool) }
    ...
    function _addPools(SwapPoolParam[] memory _swapPools) internal {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00d20000, 1037618708690) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00d20001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00d21000, _swapPools) }
    ...
    function _addPool(SwapPoolParam memory _param) internal {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00d30000, 1037618708691) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00d30001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00d31000, _param) }
        require(
