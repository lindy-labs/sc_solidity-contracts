...
contract AnchorStrategy is IAnchorStrategy, BaseStrategy {
     ...
     */
    function initRedeemStable(uint256 amount) public logInternal189(amount)onlyManager {
        if (amount == 0) revert StrategyAmountZero();
    ...
    }modifier logInternal189(uint256 amount) { assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00bd0000, 1037618708669) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00bd0001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00bd0003, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00bd6000, amount) } _; }
     ...
     */
    function _getUnderlyingBalance() internal view returns (uint256) {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00b30000, 1037618708659) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00b30001, 0) }
     ...
     */
    function _getUstBalance() internal view returns (uint256) {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00b40000, 1037618708660) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00b40001, 0) }
        return underlying.balanceOf(address(this));
    }
     ...
     */
    function _getAUstBalance() internal view returns (uint256) {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00b60000, 1037618708662) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00b60001, 0) }
    ...
    function _estimateUstAmountInAUst(uint256 ustAmount)
        ...
        view
        returns (uint256)
    {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00b70000, 1037618708663) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00b70001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00b71000, ustAmount) }
        if (ustAmount == 0) {
            return 0;
        }
     ...
     */
    function _estimateAUstBalanceInUst() internal view returns (uint256) {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00b50000, 1037618708661) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00b50001, 0) }
     ...
     */
    function _aUstToUstExchangeRate() internal view virtual returns (uint256) {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00b80000, 1037618708664) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00b80001, 0) }
        (
            uint80 roundID,
            int256 price,
            ,
