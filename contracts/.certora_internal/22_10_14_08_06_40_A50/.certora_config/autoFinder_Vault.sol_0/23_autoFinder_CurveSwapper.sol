...
abstract contract CurveSwapper {
    ...
    function _swapIntoUnderlying(
        ...
        uint256 _amount,
        uint256 _slippage
    ) internal returns (uint256 amount) {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00420000, 1037618708546) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00420001, 3) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00421000, _token) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00421001, _amount) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00421002, _slippage) }
    ...
    function _swapFromUnderlying(
        ...
        uint256 _amount,
        uint256 _slippage
    ) internal returns (uint256 amount) {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00410000, 1037618708545) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00410001, 3) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00411000, _token) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00411001, _amount) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00411002, _slippage) }
    ...
    function _approveIfNecessary(address _token, address _pool) internal {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00450000, 1037618708549) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00450001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00451000, _token) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00451001, _pool) }
    ...
    function _addPool(SwapPoolParam memory _param) internal {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00470000, 1037618708551) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00470001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00471000, _param) }
        require(
    ...
    function _removePool(address _inputToken) internal {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00480000, 1037618708552) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00480001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00481000, _inputToken) }
        require(
