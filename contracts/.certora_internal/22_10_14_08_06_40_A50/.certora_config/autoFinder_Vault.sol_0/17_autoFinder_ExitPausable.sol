...
abstract contract ExitPausable is Context {
     ...
     */
    function _requireNotExitPaused() internal view virtual {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff004d0000, 1037618708557) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff004d0001, 0) }
     ...
     * - The contract must not be exitPaused.
     */
    function _exitPause() internal virtual logInternal85()whenNotExitPaused {
        _exitPaused = true;
     ...
     * - The contract must be exitPaused.
     */
    function _exitUnpause() internal virtual logInternal86()whenExitPaused {
        _exitPaused = false;
