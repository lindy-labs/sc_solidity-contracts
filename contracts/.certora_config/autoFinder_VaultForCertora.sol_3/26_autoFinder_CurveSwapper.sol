...
abstract contract CurveSwapper {
    ...
    function _swapIntoUnderlying(
        ...
        uint256 _amount,
        uint256 _slippage
    ) internal returns (uint256 amount) {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00c00000, 1037618708672) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00c00001, 3) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00c01000, _token) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00c01001, _amount) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00c01002, _slippage) }
    ...
    function _calcMinDy(
        ...
        uint8 _toDecimals,
        uint256 _slippage
    ) internal pure returns (uint256) {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00be0000, 1037618708670) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00be0001, 4) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00be1000, _amount) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00be1001, _fromDecimals) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00be1002, _toDecimals) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00be1003, _slippage) }
        return
    ...
    function _approveIfNecessary(address _token, address _pool) internal {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00c10000, 1037618708673) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00c10001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00c11000, _token) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00c11001, _pool) }
    ...
    function _addPool(SwapPoolParam memory _param) internal {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00c30000, 1037618708675) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00c30001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00c31000, _param) }
        require(
    ...
    function _removePool(address _inputToken) internal {assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00c40000, 1037618708676) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00c40001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00c41000, _inputToken) }
        require(
