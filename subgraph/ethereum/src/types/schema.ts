...
export class Liquidation extends Entity {
  constructor(id: string) {
    ...
    this.set("txHash", Value.fromBytes(Bytes.empty()));
    this.set("liquidatedDebt", Value.fromBigInt(BigInt.zero()));
    this.set("liquidatedCollateral", Value.fromBigInt(BigInt.zero()));
    this.set("collGasCompensation", Value.fromBigInt(BigInt.zero()));
    this.set("tokenGasCompensation", Value.fromBigInt(BigInt.zero()));
    this.set("strategyBalance", Value.fromBigInt(BigInt.zero()));
  ...
  get collGasCompensation(): BigInt {
    let value = this.get("collGasCompensation");
    return value!.toBigInt();
  }

  set collGasCompensation(value: BigInt) {
    this.set("collGasCompensation", Value.fromBigInt(value));
  }

  get tokenGasCompensation(): BigInt {
    let value = this.get("tokenGasCompensation");
    return value!.toBigInt();
  }

  set tokenGasCompensation(value: BigInt) {
    this.set("tokenGasCompensation", Value.fromBigInt(value));
  }

  get strategyBalance(): BigInt {
    let value = this.get("strategyBalance");
    return value!.toBigInt();
  }

  set strategyBalance(value: BigInt) {
    this.set("strategyBalance", Value.fromBigInt(value));
  }
...
export class LiquidationState extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save LiquidationState entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        "Cannot save LiquidationState entity with non-string ID. " +
          'Considering using .toHex() to convert the "id" to a string.'
      );
      store.set("LiquidationState", id.toString(), this);
    }
  }

  static load(id: string): LiquidationState | null {
    return changetype<LiquidationState | null>(
      store.get("LiquidationState", id)
    );
  }
  ...
  set priceFeed(value: Bytes | null) {
    if (!value) {
      this.unset("priceFeed");
    } else {
      this.set("priceFeed", Value.fromBytes(<Bytes>value));
    }
  }
